...
namespace TeduShop.Data.Infrastructure
{
    public abstract class RepositoryBase<T> where T:class
    {
        ...
        public virtual IQueryable<T> GetMultiPaging(Expression<Func<T,bool>>expression,out int total,int index=0, int size = 50, string[] includes = null)
        {
            ...
            {
                _resetSet = expression != null ? dataContext.Set<T>().Where<T>(expression).AsQueryable() : dataContext.Set<T>().AsQueryable(); 
            }
